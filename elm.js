...
Elm.NotQuiteLispWhere = Elm.NotQuiteLispWhere || {};
Elm.NotQuiteLispWhere.make = function (_elm) {
   "use strict";
   _elm.NotQuiteLispWhere = _elm.NotQuiteLispWhere || {};
   if (_elm.NotQuiteLispWhere.values) return _elm.NotQuiteLispWhere.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   0,
   A2($List.map,function (n) {    return _U.eq(n,_U.chr("(")) ? 1 : -1;},$String.toList(input)))));
   var fold = F2(function (acc,l) {    return _U.eq(l,"(") ? acc + 1 : acc - 1;});
   return _elm.NotQuiteLispWhere.values = {_op: _op,fold: fold,main: main,input: input};
};
