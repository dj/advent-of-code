...
Elm.Day3 = Elm.Day3 || {};
Elm.Day3.make = function (_elm) {
   "use strict";
   _elm.Day3 = _elm.Day3 || {};
   if (_elm.Day3.values) return _elm.Day3.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   ...
   var nextPos = F2(function (pos,instruction) {
      return _U.eq(_U.chr("<"),instruction) ? {ctor: "_Tuple2",_0: $Basics.fst(pos) - 1,_1: $Basics.snd(pos)} : _U.eq(_U.chr("^"),
      instruction) ? {ctor: "_Tuple2",_0: $Basics.fst(pos),_1: $Basics.snd(pos) + 1} : _U.eq(_U.chr(">"),instruction) ? {ctor: "_Tuple2"
                                                                                                                        ,_0: $Basics.fst(pos) + 1
                                                                                                                        ,_1: $Basics.snd(pos)} : {ctor: "_Tuple2"
                                                                                                                                                 ,_0: $Basics.fst(pos)
                                                                                                                                                 ,_1: $Basics.snd(pos) - 1};
   });
   var moveSleigh = F3(function (instructions,currentPos,seen) {
      moveSleigh: while (true) {
         var _p0 = instructions;
         if (_p0.ctor === "::") {
               var _v1 = _p0._1,_v2 = A2(nextPos,currentPos,_p0._0),_v3 = A3($Dict.insert,currentPos,true,seen);
               instructions = _v1;
               currentPos = _v2;
               seen = _v3;
               continue moveSleigh;
   ...
   var housesVisitedPart1 = function (instructions) {
      var start = {ctor: "_Tuple2",_0: 0,_1: 0};
      return $Dict.size(A3(moveSleigh,instructions,start,$Dict.empty));
   };
   var moveSleigh2 = F5(function (idx,instructions,pos1,pos2,seen) {
      moveSleigh2: while (true) {
         var _p1 = instructions;
         if (_p1.ctor === "::") {
               var _p3 = _p1._1;
               var _p2 = _p1._0;
               if (_U.eq(A2($Basics._op["%"],idx,2),1)) {
                     var _v5 = idx + 1,_v6 = _p3,_v7 = A2(nextPos,pos1,_p2),_v8 = pos2,_v9 = A3($Dict.insert,pos1,true,seen);
                     idx = _v5;
                     instructions = _v6;
                     pos1 = _v7;
                     pos2 = _v8;
                     seen = _v9;
                     continue moveSleigh2;
                  } else {
                     var _v10 = idx + 1,_v11 = _p3,_v12 = pos1,_v13 = A2(nextPos,pos2,_p2),_v14 = A3($Dict.insert,pos2,true,seen);
                     idx = _v10;
                     instructions = _v11;
                     pos1 = _v12;
                     pos2 = _v13;
   ...
   var housesVisitedPart2 = function (instructions) {
      var seen = A5(moveSleigh2,0,instructions,{ctor: "_Tuple2",_0: 0,_1: 0},{ctor: "_Tuple2",_0: 0,_1: 0},$Dict.empty);
      return $Dict.size(seen);
   };
   var main = function () {
      var instructions = $String.toList(input);
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Day 3")]))
              ,A2($Html.h2,_U.list([]),_U.list([$Html.text("Part 1")]))
              ,A2($Html.p,_U.list([]),_U.list([$Html.text($Basics.toString(housesVisitedPart1(instructions))),$Html.text(" houses visited.")]))
              ,A2($Html.h2,_U.list([]),_U.list([$Html.text("Part 2")]))
              ,A2($Html.p,_U.list([]),_U.list([$Html.text($Basics.toString(housesVisitedPart2(instructions))),$Html.text(" houses visited.")]))]));
   }();
   return _elm.Day3.values = {_op: _op
                             ,nextPos: nextPos
                             ,moveSleigh: moveSleigh
                             ,housesVisitedPart1: housesVisitedPart1
                             ,moveSleigh2: moveSleigh2
                             ,housesVisitedPart2: housesVisitedPart2
                             ,main: main
                             ,input: input};
};
